...
& $python $otatool --port $Port erase_otadata
if ($LASTEXITCODE -ne 0) {
    throw "Factory switch failed. Check the board port: $Port"
}
Write-Host "Factory firmware selected. The board is rebooting."
